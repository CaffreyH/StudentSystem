...
public class tscoresearch extends JFrame implements ActionListener{
	static final String ip ="jdbc:mysql://localhost:3306/info?characterEncoding=UTF-8";
	private JPanel contentPane_tcourse;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					//tscoresearch frame = new tscoresearch();
	 ...
	 * Create the frame.
	 */
	public tscoresearch(String id) {
		id2 = id;
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(300,100,600,400);
		contentPane_tcourse = new JPanel();
		contentPane_tcourse.setLayout(null);
		setContentPane(contentPane_tcourse);
